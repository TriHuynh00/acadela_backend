...
define case MI1_Headache
    ...
    SummaryPanel
        Section TreatmentGoal #left
            label = "Treatment Goal:"
            InfoPath TreatmentApproval.DiscussTreatment.TreatmentGoal

        Section HowPainOccur #left
            label = "How did it start?"
            InfoPath Questioning.QuestionPatientCondition.HowHeadacheStart

        Section HowOften #left
            label = "How often?"
            InfoPath Questioning.QuestionPatientCondition.HeadacheFrequency

        Section SleepCondition #left
            label = "Sleep Condition:"
            InfoPath Questioning.QuestionPatientCondition.SleepCondition

        Section MassagePosition #center
            label = "Massaging Points"
            InfoPath Massaging.MassageHead.MassageLocationVisual

        Section MassageConsent #right
            label = "Massage Consent:"
            InfoPath TreatmentApproval.DiscussTreatment.MassageConsent

        Section AcupunctureConsent #right
            label = "Acupuncture Consent:"
            InfoPath TreatmentApproval.DiscussTreatment.AcupunctureConsent

        Section GuashaConsent #right
            label = "Guasha Consent:"
            InfoPath TreatmentApproval.DiscussTreatment.GuashaConsent
    ...
    Stage Massaging
        ...
        Precondition
            ...
            condition = "TreatmentApproval.DiscussTreatment.MassageConsent > 0"
    ...
    Stage Acupuncture
        ...
        Precondition
            previousStep = "TreatmentApproval"
            condition = "TreatmentApproval.DiscussTreatment.AcupunctureConsent > 0"
    ...
    Stage Guasha
        ...
        Precondition
            previousStep = "TreatmentApproval"
            condition = "TreatmentApproval.DiscussTreatment.GuashaConsent > 0"
