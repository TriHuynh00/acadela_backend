    ...
    define case PII1_COPD
        ...
        Responsibilities
            ...
            Setting
                ...
                SummaryPanel
                    Section PrevExerciseShoulder #left
                        label = "Shoulder was increased accurately?"
                        InfoPath Exercise.BreathingExercise.ShoulderIncrease
            
                    Section PrevBellyExpansion #left
                        label = "Belly was expanded properly?"
                        InfoPath Exercise.BreathingExercise.BellyExpansion
                        
                    Section PrevSittingPosture #left
                        label = "Sitting posture was correct?"
                        InfoPath Exercise.BreathingExercise.SittingPosture
